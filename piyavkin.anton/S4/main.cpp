...
int main(int argc, char* argv[])
{
  ...
  std::cout << tree.insert(tree.cbegin(), std::make_pair< int, int >(1,1))->second;
  std::cout << tree.insert(tree.cbegin(), std::make_pair< int, int >(-5, -5))->second;
  std::cout << tree.insert(++tree.cbegin(), std::make_pair< int, int >(0, 0))->second;
  std::cout << tree.insert(tree.cend(), std::make_pair< int, int >(6, 6))->second;
  std::cout << tree.insert(--tree.cend(), std::make_pair< int, int >(5, 5))->second;
  auto it = --tree.cend();
  std::cout << tree.insert(--it, std::make_pair< int, int >(3, 3))->second;
  tree.find(3);
}
