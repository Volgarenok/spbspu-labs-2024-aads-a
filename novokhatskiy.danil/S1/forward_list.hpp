...
namespace novokhatskiy
{
  ...
  public:
    ...
    ForwardList(const T &value) : head_(make_list(1, value))
    {
    }
    ...
    ForwardList(const ForwardList<T> &other) : head_(make_list(other.cbegin(), other.cend()))
    {
    }
    // использовать make_list
    ForwardList(size_t size, const T &value) : head_(make_list(size, value))
    {
    }
    // использовать make_list
    ForwardList(std::initializer_list<T> list) : head_(make_list(list.cbegin(), list.cend()))
    {
    }
  ...
  private:
    ...
    static node_t *make_list(It first, It last)
    {
      ...
      {
        novokhatskiy::detail::Node<T>::freeNode(new_head);
        throw;
      }
      return new_head;
    }
    ...
    static node_t *make_list(size_t count, const T &value)
    {
      ...
      {
        novokhatskiy::detail::Node<T>::freeNode(new_node);
        throw;
      }
      return new_node;
    }
