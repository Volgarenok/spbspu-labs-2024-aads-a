...
void prisyach::print_dictionary(const dic& dictionary, std::ostream& out)
{
...
void prisyach::print_dictionaryL(const dic& dictionary, int n, std::ostream& out)
{
  for (auto it = dictionary.cbegin(); it != dictionary.cend(); ++it)
  {
    if (it->second > n)
...
void prisyach::addelem(mainDic& dictionaries, std::istream& in)
{
...
void prisyach::save(const mainDic& dictionaries, std::istream& in)
{
  std::string datasetName = "";
  std::string fileName = "";
...
void prisyach::intersect(mainDic& dictionaries, std::istream& in)
{
  unionCmds(dictionaries, in, intersectImpl);
}
void prisyach::addition(mainDic& dictionaries, std::istream& in)
{
  unionCmds(dictionaries, in, additionImpl);
}
void prisyach::complement(mainDic& dictionaries, std::istream& in)
{
  unionCmds(dictionaries, in, complementImpl);
}
prisyach::dic prisyach::intersectImpl(const dic& dict1, const dic& dict2)
{
  dic result;
...
void prisyach::printInfo(std::ostream& out)
{
...
prisyach::dic prisyach::additionImpl(const dic& dict1, const dic& dict2)
{
  dic result = dict1;
  for (auto it2 = dict2.cbegin(); it2 != dict2.cend(); ++it2)
  {
...
prisyach::dic prisyach::complementImpl(const dic& dict1, const dic& dict2)
{
  dic result = dict1;
  for (auto it1 = dict1.cbegin(); it1 != dict1.cend(); ++it1)
  {
...
void prisyach::deleteDict(mainDic& dictionaries, std::istream& in)
{
  std::string datasetName = "";
  in >> datasetName;
  auto it = dictionaries.find(datasetName);
...
void prisyach::deleteName(mainDic& dictionaries, std::istream& in)
{
  std::string datasetName = "";
  std::string name = "";
  in >> datasetName >> name;
...
void prisyach::print_dictionaries(const mainDic& dictionaries, std::istream& in, std::ostream& out)
{
  std::string s = "";
  in >> s;
  auto it = dictionaries.cbegin();
  if (it == dictionaries.cend())
  {
    throw std::overflow_error("<EMPTY>");
  }
  for (; it != dictionaries.cend(); ++it)
  {
    if (s == it->first)
    {
      if (it->second.empty())
...
void prisyach::print_dictionariesL(const mainDic& dictionaries, std::istream& in, std::ostream& out)
{
  size_t n = 0;
  std::string s = "";
  in >> s >> n;
