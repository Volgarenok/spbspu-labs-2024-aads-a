...
bool isLowerPriority(const prisyach::InfixType & lhs, const prisyach::InfixType & rhs)
{
...
prisyach::Queue< prisyach::PostfixType > prisyach::convertToPostfix(Queue< InfixType > & queue_source)
{
